...
from exs_shell_deprecated.modules.dashboard.pages.main import MainPage
from exs_shell_deprecated.modules.dashboard.pages.metrics import MetricsPage
from exs_shell_deprecated.modules.dashboard.pages.player import PlayerPage
