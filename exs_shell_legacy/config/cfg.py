...
from exs_shell_deprecated.config.log import logger
from exs_shell_deprecated.base.singleton import SingletonClass
from exs_shell_deprecated.ipc_utils.server import run_ipc_server
from exs_shell_deprecated.utils import PathUtils, Dirs, send_notification, kill_process
...
class Config(SingletonClass):
    ...
    def init_widgets(self) -> None:
        from exs_shell_deprecated.modules.osd import OSD, OSDTrigger
        from exs_shell_deprecated.modules.bar import Bar
        from exs_shell_deprecated.modules.notification import NotificationPopup, NotificationCenter
        from exs_shell_deprecated.modules.clipboard import ClipboardManager
        from exs_shell_deprecated.modules.launcher import Launcher
        from exs_shell_deprecated.modules.powermenu import PowerMenu, PowerMenuTrigger
        from exs_shell_deprecated.modules.dashboard import Dashboard, DashboardTrigger
        from exs_shell_deprecated.modules.lockscreen import LockScreen
        from exs_shell_deprecated.window import Settings
        from exs_shell_deprecated.window.wallpaper import Wallpaper
